...
using Udemy.App.Business.Services;
using Udemy.App.Business.ValidationRules;

using Udemy.App.DataAccess.Contexts;
using Udemy.App.DataAccess.UnitOfWork;
using Udemy.App.Dtos;

namespace Udemy.App.Business.DependencyResolvers.Microsoft
{
    public static class DependencyExtension
    {
        public static void AddDependencies(this IServiceCollection services, IConfiguration configuration)
        {
            services.AddDbContext<UygulamaContext>(opt =>
            {
